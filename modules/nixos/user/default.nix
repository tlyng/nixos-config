...
in
{
  options.${namespace}.user = with types; {
    name = mkOpt str "torkel" "The name to use for the user account.";
    fullName = mkOpt str "Torkel Lyng" "The full name of the user.";
    email = mkOpt str "me@tlyng.no" "The email of the user.";
    initialPassword =
      mkOpt str "password"
  ...
  config = {
    ...
    homelab.home = {
      file = {
        ...
        "Pictures/something.jpg".source = ./Profile.jpg;
      };
